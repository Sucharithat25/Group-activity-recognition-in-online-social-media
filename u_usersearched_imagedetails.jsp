...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <p align="center" class="style3">Image Details...</p>
          <h1 class="style23 style11"><span class="style12">Searched post</span> <span class="style8"><%=request.getParameter("p_Name")%></span><span class="style12"> Details</span></h1>
    <p class="style6">&nbsp;</p>
    <p>
<%
try 
...
%>
      ...
      <tr>
        ...
        <td valign="middle"><div align="center">
		  ...
		  <a href="u_Recommend_image_ToAll.jsp?p_Name=<%=p_Name%>&amp;categorie=<%=categorie%>"></a>
		  </span> To Friend
		  </p>
