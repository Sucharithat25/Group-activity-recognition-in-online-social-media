...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <p align="center" class="style3">Show Your Interest By Rating...</p>
      	...
      	try 
	{
          ...
          <form action="u_Recommendation1.jsp?type=<%="rank"%>" method="post" id="form1"><div align="center" class="style1">
            <table width="428" border="0">
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td><label>
                    <input name="Submit" type="submit" class="style3" value="Give Rating" />
                  </label></td>
                </tr>
              </table>
            </div>
