...
<%
		...
		%><p align="right"><a href="a_all_posts1.jsp?pname=<%=pname%>" class="style9">Back</a></p>
<%
		}
		if(type.equalsIgnoreCase("three"))
		{
		%><p align="right"><a href="a_pos_neg_reviews.jsp" class="style9">Back</a></p>
<%
		}
		if(type.equalsIgnoreCase("four"))
		{
		 String pname=request.getParameter("pname");
		%><p align="right"><a href="a_all_movies1.jsp?pname=<%=pname%>" class="style9">Back</a></p>
<%
		}
		if(type.equalsIgnoreCase("five"))
		{
		%><p align="right"><a href="a_pos_neg_mreviews.jsp" class="style9">Back</a></p>
<%
		}
		if(type.equalsIgnoreCase("six"))
		{
		%><p align="right"><a href="a_all_history.jsp" class="style9">Back</a></p>
<%
		}
		if(type.equalsIgnoreCase("seven"))
		{
		%><p align="right"><a href="a_all_purchased.jsp" class="style9">Back</a></p>
<%
		}
        if(type.equalsIgnoreCase("eight"))
		{
		%><p align="right"><a href="a_pro_recom.jsp" class="style9">Back</a></p>
<%
		}
        if(type.equalsIgnoreCase("nine"))
		{
		%><p align="right"><a href="a_movie_recom.jsp" class="style9">Back</a></p>
<%
		}
