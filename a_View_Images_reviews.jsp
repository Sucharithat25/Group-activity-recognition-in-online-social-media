...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <p align="center" class="style3">View All Images Review!!!</p>
          ...
          <tr>
            ...
            <td  width="82" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style15 style21 style7 style6 style5"><strong>Rate</strong></div></td>
			 <td  width="82" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style15 style21 style7 style6 style5"><strong>View Review Behavior</strong></div></td>
          </tr>
...
<%@ page import="java.sql.*,java.io.*,java.util.*" %> 
          ...
          <tr>
			...
			<td  valign="baseline" height="0"><p class="style22 style4 style5">&nbsp;</p>
              <div align="center" class="style22 style4 style5"> <a href="a_View_allReviews.jsp?p_Name=<%=s1%>" class="style34">View Review</a><span class="style19">
            <td><a href="a_View_allReviews.jsp?p_Name=<%=s1%>" class="style34"></a> </td>
                  <p>&nbsp; </p>
            </div></td>
          </tr>
          <%
