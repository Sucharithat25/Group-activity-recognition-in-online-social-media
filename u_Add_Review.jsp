...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="clr"></div>
      <div class="slider">
        <div id="coin-slider"> <a href="#"><img src="https://media.istockphoto.com/vectors/social-network-scheme-which-contains-people-connected-to-each-other-vector-id640162840" width="960" height="320" alt="" /></a> <a href="#"><img src="https://s27389.pcdn.co/wp-content/uploads/2017/06/AdobeStock_81441025-1-1024x594.jpeg" width="960" height="320" alt="" /></a> <a href="#"><img src="https://media.istockphoto.com/vectors/social-network-scheme-which-contains-people-connected-to-each-other-vector-id640162840" width="960" height="320" alt="" /></a> </div>
        <div class="clr"></div>
      </div>
      <div class="clr"></div>
    </div>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p align="center" class="style3">Add Review !!!</p>
          <p align="center" class="style3">&nbsp;</p>
      	...
      	try 
	{
		   ...
		   %></strong></pre>
      <h2>&nbsp;</h2>
      <div id="templatemo_right_section"><form action="u_Add_Review1.jsp"  method="post" id="form1">
	  
        <table width="428" border="0">
              <tr>
                <td width="188" height="35"><div align="center" class="style9 style14"><strong>Image Name </strong></div></td>
                <td width="230"><label>
                  <input type="text" name="p_Name" value="<%=p_Name%>" readonly="readonly" />
                </label></td>
              </tr>
              <tr>
                <td height="37"><div align="center" class="style9 style14"><strong>Categorie</strong></div></td>
                <td><label>
                  <input type="text" name="categorie" value="<%=categorie%>" readonly="readonly" />
                </label></td>
              </tr>
              <tr>
                <td height="52"><div align="center" class="style9 style14"><strong>Enter Your Review</strong></div></td>
